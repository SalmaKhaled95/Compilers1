...
void term(){ factor(); cout<< "Term found"<<"\n"; while(token== "*"||token== "/" ){  mulop(); factor(); cout<< "Term found"<<"\n";}}
...
////else error();
// cout<< "Factor found"<<"\n";}
void factor(){if (token== "("){ match("("); exp(); match(")"); cout<< "Factor found"<<"\n";}
 else if (token== "number") {match("number"); cout<< "Factor found"<<"\n";}
 else if (token== "identifier") {match("identifier"); cout<< "Factor found"<< "\n";}
//else error();
 //cout<< "Factor found"<<"\n";
 }
